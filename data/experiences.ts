...
export const experiences: ExperienceType[] = [
  ...
  },
  {
    ...
    description: '関連子会社の収支決算をまとめるグループ決算システム。チーム5名（PM/1名、PL/1名、PG/3名）体制で、権限昇格攻撃対応とAPI調査を担当。',
    achievements: [
      '権限昇格攻撃対応：一般ユーザーから管理者への権限昇格を防ぐため、API側に権限チェック処理を追加',
      'TypeScript/Jestによる自動テストコードの作成',
      '結合テスト、パフォーマンステスト、モンキーテストの手動テスト実施',
      '各API調査を実施し、呼び出し元を調査して仕様書を作成',
    ],
  ...
  },
  {
    ...
    description: '販売会社や自動車メーカー間での販売状況などの分析用システムのAWSへの近代化プロジェクト。チーム4名（PM/1名、PL/1名、PG/2名）体制。',
    achievements: [
      'VBAツール4本、WPFツール1本を開発（標準モジュール判定・エクスポートツール、VBAフォーム識別ツールなど）',
      'RDS/SQLServer接続用WebServiceの開発（ASP.NET）',
      'EC2サーバPOC環境構築（IIS、WebDav、WebService、OpenSSH設定）',
      'HTTP→HTTPS接続へ変更、SQLインジェクション対策を実施',
      'バッチのFTP→SFTP化を実現',
      'アプリケーション運用設計書・移行設計書の作成、各資源のデプロイを実施',
    ],
