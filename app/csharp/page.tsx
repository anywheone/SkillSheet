    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 py-8 px-4">
      <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-0">
              {mainProjects.map((exp) => (
                <ExperienceCard
                  ...
                  technologies={sortTechnologies(exp.technologies, 'csharp')}
                />
              ))}
            </div>
          </Section>
                ...
                {otherExperiences.map((exp) => (
                  <div key={exp.id} className="border-l-4 border-blue-500 pl-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {sortTechnologies(exp.technologies, 'csharp').slice(0, exp.id === 'training' ? undefined : 6).map((tech) => (
                        <span
                          key={tech}
        ...
        <footer className="text-center text-gray-500 dark:text-gray-400 mt-12 pb-8">
          <p className="text-sm">© 2025 {FOOTER_INFO.copyright} - C#/.NETエンジニア スキルシート</p>
